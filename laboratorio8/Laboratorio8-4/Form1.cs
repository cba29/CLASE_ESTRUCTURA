namespace Laboratorio8_4
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            Button buttonFiltrar = new Button { Text = "Filtrar Comunes", Location = new System.Drawing.Point(10, 130), AutoSize = true };
            buttonFiltrar.Click += ButtonFiltrar_Click;

            ListBox listBoxNumerosComunes = new ListBox { Name = "listBoxNumerosComunes", Location = new System.Drawing.Point(10, 160), Width = 350, Height = 100 };
            ...
            Controls.Add(listBoxNumerosComunes);
        }
        ...
        private void ButtonFiltrar_Click(object sender, EventArgs e)
        {
            ...
            HashSet<int> numerosComunes = FiltrarNumerosComunes(conjunto1, conjunto2);

            ListBox listBoxNumerosComunes = (ListBox)Controls["listBoxNumerosComunes"];
            listBoxNumerosComunes.Items.Clear();
            foreach (int numero in numerosComunes)
            {
                listBoxNumerosComunes.Items.Add(numero);
            }
        }

        // Función que filtra los números
        private HashSet<int> FiltrarNumerosComunes(HashSet<int> conjunto1, HashSet<int> conjunto2)
        {
